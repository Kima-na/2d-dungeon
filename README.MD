...
3주차 주간보고: [WEEKLY_REPORT_WEEK3.md](WEEKLY_REPORT_WEEK3.md)
...
| `BossRoster` | 난이도에 맞는 보스 능력치와 구성요소 생성 | `BossMovement`, `BossCombat`, `BossHealth`, `BossAnimator` 설정 |
| `BossMovement` | 보스 전용 추적과 위치 제어 | 공격 상태를 존중하며 플레이어와의 거리를 조절 |
